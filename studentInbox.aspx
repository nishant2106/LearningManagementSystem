<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentInbox.aspx.cs" Inherits="studentInbox" %>
    ...
    <div class="con">
        <h3 style="margin-left:10px;margin-top:20px; text-align:left; font-size: 43px;margin-bottom: 0px;text-align:center">Inbox</h3>
          <div class="nisdiv" style="table-layout: auto">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <asp:TextBox ID="TextBox1" runat="server" Width="643px"></asp:TextBox><asp:Button ID="Button1" runat="server" Text="Send" OnClick="Button1_Click" /><br />
              <br />
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None"
                 ShowFooter="True" style="text-align: center; top: 312px; position:absolute; left: 299px; height: 373px; width: 972px;" DataSourceID="SqlDataSource1"
                 ViewStateMode="Enabled" Height="100%" CssClass="grid" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
