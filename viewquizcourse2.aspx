<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewquizcourse2.aspx.cs" Inherits="viewquizcourse2" %>
    ...
    <div class="con">
        ...
        <div class="nisdiv">
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CellPadding="4" ForeColor="#333333" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="operations">
                        <EditItemTemplate>
                            ...
                            &nbsp;<asp:LinkButton ID="LinkButton4" runat="server" CommandName="Cancle" OnClick="LinkButton3_Click">Cancle</asp:LinkButton>
                        </EditItemTemplate>
                        <FooterTemplate>
            ...
            <br />
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:glsConnectionString %>" DeleteCommand="DELETE FROM [coursequiz2] WHERE [QuizID] = @QuizID" InsertCommand="INSERT INTO [coursequiz2] ([question], [A], [B], [C], [D], [answer]) VALUES (@question, @A, @B, @C, @D, @answer)" SelectCommand="SELECT * FROM [coursequiz2]" UpdateCommand="UPDATE [coursequiz2] SET [question] = @question, [A] = @A, [B] = @B, [C] = @C, [D] = @D, [answer] = @answer WHERE [QuizID] = @QuizID">
                <DeleteParameters>
