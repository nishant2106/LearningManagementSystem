...
public partial class login : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
       String query ="Select emailid,password from student_regi where emailid='" + TextBox1.Text + "' and password='" + TextBox2.Text + "'";
       cmd.CommandText = query;
            ...
            {
                //Label1.Text = "Entered credentials are incorrect.";
