...
public partial class coursequigen3 : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into coursequiz3(question,A,B,C,D,answer) values(@question,@A,@B,@C,@D,@answer)", con);
            ...
            Response.Redirect("coursequigen3.aspx");
        }
    }
