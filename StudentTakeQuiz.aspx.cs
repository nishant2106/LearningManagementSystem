...
public partial class StudentTakeQuiz : System.Web.UI.Page
{
    ...
    protected void showrec()
    {
        ...
        cmd = new SqlCommand();
        cmd.CommandText = "select * FROM admin_quiz";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            SqlConnection con = new SqlConnection(@"Data Source=NISHANT\SQLEXPRESS;Initial Catalog=gls;Integrated Security=True");
            con.Open();
            String query = "insert into result(username,score)values('" + Session["username"] + "','" + count + "')";
