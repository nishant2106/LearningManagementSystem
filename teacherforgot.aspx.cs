...
public partial class teacherforgot : System.Web.UI.Page
{
    public string otp;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("Select emailid from teacher_reg where emailid='" + TextBox1.Text + "'", con);
        SqlDataReader dr;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (TextBox2.Text == otp)
        {
            ...
            Response.Redirect("teacherchangepass.aspx");
        }
        else
        {
