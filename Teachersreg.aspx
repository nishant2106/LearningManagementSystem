<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Teachersreg.aspx.cs" Inherits="Teacher_sreg" %>
    ...
    <body>
        <div class="registration-box">
            ...
            <form id="form1" runat="server">
                ...
                <br />
                Master Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <asp:TextBox ID="TextBox7" runat="server" TextMode="Password" Width="185px"></asp:TextBox>
                <br />
                <br />
