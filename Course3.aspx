<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Course3.aspx.cs" Inherits="Course3" %>
<!DOCTYPE html>
  ...
  <div class="nisdiv"> 
      ...
      <table style="width:100%;">
          ...
          <tr>
              ...
              <td>
                  <asp:Label ID="Label4" runat="server" Text="CSQuiz1"></asp:Label>
              </td>
          ...
          <tr>
              <td>&nbsp;</td>
              <td>
                  <asp:Button ID="Button1" runat="server" Text="Take Quiz" BackColor="#0066FF" ForeColor="Black" PostBackUrl="~/Course3quiz.aspx" />
