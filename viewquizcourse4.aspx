<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewquizcourse4.aspx.cs" Inherits="viewquizcourse4" %>
...
<body>
     ...
     <div id="header">
        <div id="header2"><h1 class="header1">GPM Learning System</h1>
         </div>
        </div>
        <div class="nav">
            <ul>
    ...
    <div class="con">
        ...
        <div class="nisdiv">
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CellPadding="4" ForeColor="#333333" GridLines="None"
            ...
            <br />
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:glsConnectionString %>" DeleteCommand="DELETE FROM [coursequiz4] WHERE [QuizID] = @QuizID" InsertCommand="INSERT INTO [coursequiz4] ([question], [A], [B], [C], [D], [answer]) VALUES (@question, @A, @B, @C, @D, @answer)" SelectCommand="SELECT * FROM [coursequiz4]" UpdateCommand="UPDATE [coursequiz4] SET [question] = @question, [A] = @A, [B] = @B, [C] = @C, [D] = @D, [answer] = @answer WHERE [QuizID] = @QuizID">
                <DeleteParameters>
