<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StdSyllabus.aspx.cs" Inherits="StdSyllabus" %>
...
<body>
    ...
    <div class="con">
        <h3 style="margin-left:10px;margin-top:20px; text-align:left; font-size: 43px;margin-bottom: 0px;text-align:center">Syllabus</h3>
         <div class="nisdiv">
            <br />
