...
public partial class teacherQuizGen : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("insert into admin_quiz(question,A,B,C,D,answer) values(@question,@A,@B,@C,@D,@answer)", con);
            ...
            Response.Redirect("teacherQuizGen.aspx");
        }
    }
