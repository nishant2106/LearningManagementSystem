<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentchangepass.aspx.cs" Inherits="studentchangepass" %>
...
<head>
    ...
    <body>
        ...
        <h1 style="color: #FFFFFF;text-align:center">Change Password</h1>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:glsConnectionString %>" UpdateCommand="UPDATE [student_regi] SET [password] = @password,[cpass] = @cpass WHERE [emailid] = @emailid">
      <UpdateParameters>
