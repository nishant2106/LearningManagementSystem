<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tcourse2.aspx.cs" Inherits="tcourse2" %>
	...
	<li><a href="teacherProfile.aspx">Profile</a></li>
      ...
      <table style="width:100%;">
          ...
          <tr>
              <td>&nbsp;</td>
              <td>
                  <asp:Button ID="Button1" runat="server" Text="Create Quiz" BackColor="#0066FF" ForeColor="Black" PostBackUrl="~/coursequigen2.aspx" />
