...
public partial class viewquizcourse1 : System.Web.UI.Page
{
    ...
    void PopulateGridview()
    {
        ...
        {
            sqlCon.Open();
            SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM coursequiz1", sqlCon);
            sqlDa.Fill(dtbl);
        }
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        String mycon = "Data Source=NISHANT\\SQLEXPRESS;Initial Catalog=gls;Integrated Security=True";
        String updatedata = "Update coursequiz1 set question='" + question.Text + "', A='" + A.Text + "', B='" + B.Text + "', C='" + C.Text + "', D='" + D.Text + "', answer='" + answer.Text + "' where QuizID='" + QuizID.Text + "'";
    ...
    protected void LinkButton5_Click(object sender, EventArgs e)
    {
        ...
        String query = "set identity_insert admin_quiz ON;" + "insert into coursequiz1 (QuizID,question,A,B,C,D,answer) Values('" + QuizID.Text + "','" + question.Text + "','" + A.Text + "','" + B.Text + "','" + C.Text + "','" + D.Text + "','" + answer.Text + "')" + "SET IDENTITY_INSERT admin_quiz OFF;";
        String mycon = "Data Source=NISHANT\\SQLEXPRESS;Initial Catalog=gls;Integrated Security=True";
        SqlConnection con = new SqlConnection(mycon);
        con.Open();
        SqlCommand cmd = new SqlCommand();
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        String mycon = "Data Source=NISHANT\\SQLEXPRESS;Initial Catalog=gls;Integrated Security=True";
        String updatedata = "delete from coursequiz1 where QuizID=" + QuizID.Text;
        SqlConnection con = new SqlConnection(mycon);
        con.Open();
        SqlCommand cmd = new SqlCommand();
        cmd.CommandText = updatedata;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        String query = "delete coursequiz1";
        String mycon = "Data Source=NISHANT\\SQLEXPRESS;Initial Catalog=gls;Integrated Security=True";
        SqlConnection con = new SqlConnection(mycon);
        con.Open();
        SqlCommand cmd = new SqlCommand();
