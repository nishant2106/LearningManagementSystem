<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewquizcourse1.aspx.cs" Inherits="viewquizcourse1" %>
    ...
    <div class="con">
        ...
        <div class="nisdiv">
           ...
           <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CellPadding="4" ForeColor="#333333" GridLines="None"
            ...
            <br />
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:glsConnectionString %>" DeleteCommand="DELETE FROM [coursequiz1] WHERE [QuizID] = @QuizID" InsertCommand="INSERT INTO [coursequiz1] ([question], [A], [B], [C], [D], [answer]) VALUES (@question, @A, @B, @C, @D, @answer)" SelectCommand="SELECT * FROM [coursequiz1]" UpdateCommand="UPDATE [coursequiz1] SET [question] = @question, [A] = @A, [B] = @B, [C] = @C, [D] = @D, [answer] = @answer WHERE [QuizID] = @QuizID">
                <DeleteParameters>
