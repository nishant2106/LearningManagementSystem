<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewQuizGen(CRUD).aspx.cs" Inherits="ViewQuizGen_CRUD_" %>
...
<body>
    ...
    <div class="con">
        ...
        <div class="nisdiv" style="table-layout: auto">
            ...
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:glsConnectionString %>" DeleteCommand="DELETE FROM [admin_quiz] WHERE [QuizID] = @QuizID" InsertCommand="INSERT INTO [admin_quiz] ([question], [A], [B], [C], [D], [answer]) VALUES (@question, @A, @B, @C, @D, @answer)" SelectCommand="SELECT * FROM [admin_quiz]" UpdateCommand="UPDATE [admin_quiz] SET [question] = @question, [A] = @A, [B] = @B, [C] = @C, [D] = @D, [answer] = @answer WHERE [QuizID] = @QuizID">
                <DeleteParameters>
