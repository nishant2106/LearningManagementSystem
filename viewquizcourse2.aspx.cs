...
public partial class viewquizcourse2 : System.Web.UI.Page
{
    ...
    void PopulateGridview()
    {
        ...
        {
            sqlCon.Open();
            SqlDataAdapter sqlDa = new SqlDataAdapter("SELECT * FROM coursequiz2", sqlCon);
            sqlDa.Fill(dtbl);
        }
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        String mycon = "Data Source=NISHANT\\SQLEXPRESS;Initial Catalog=gls;Integrated Security=True";
        String updatedata = "Update coursequiz2 set question='" + question.Text + "', A='" + A.Text + "', B='" + B.Text + "', C='" + C.Text + "', D='" + D.Text + "', answer='" + answer.Text + "' where QuizID='" + QuizID.Text + "'";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        String mycon = "Data Source=NISHANT\\SQLEXPRESS;Initial Catalog=gls;Integrated Security=True";
        String updatedata = "delete from coursequiz2 where QuizID=" + QuizID.Text;
        SqlConnection con = new SqlConnection(mycon);
        con.Open();
        SqlCommand cmd = new SqlCommand();
        cmd.CommandText = updatedata;
