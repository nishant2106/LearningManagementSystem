...
&nbsp;  
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:glsConnectionString %>" SelectCommand="SELECT * FROM [result2]"></asp:SqlDataSource>
