<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tcourse3.aspx.cs" Inherits="tcourse3" %>
	...
	<li><a href="teacherProfile.aspx">Profile</a></li>
      ...
      <table style="width:100%;">
          ...
          <tr>
              <td>&nbsp;</td>
              <td>
                  <asp:Button ID="Button1" runat="server" Text="Create Quiz" BackColor="#0066FF" ForeColor="Black" PostBackUrl="~/coursequigen3.aspx" />
