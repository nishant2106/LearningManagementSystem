...
public partial class course1 : System.Web.UI.Page
{
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        {
            FileUpload1.PostedFile.SaveAs(Server.MapPath("~/Data1/") + FileUpload1.FileName);
        }
        ...
        foreach (string strFile in Directory.GetFiles(Server.MapPath("~/Data1/")))
        {
    ...
    protected void GridView1_RowCommand1(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Download")
        {
            ...
            Response.TransmitFile(Server.MapPath("~/Data1/") + e.CommandArgument);
            Response.End();
